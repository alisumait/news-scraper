...
req = Request('http://abcnews.go.com/International/wireStory/150-killed-weekend-violence-yemens-hodeida-58957129?cid=clicksource_76_2_hero_headlines_headlines_hed', headers={'User-Agent': 'Mozilla/5.0'})
...
def filter(pat, txt, q):
    for r in range(len(pat)-1, -1, -1):
        ...
        for i in range(N - M + 1):
                ...
                if i >= N-M:
                    if cond == False:
                        # delete items that have not matches
                        del pat[r]
...
if positive-sent > negative:
    ...
    print("Article sentiment is negative!")
else:
